...
export function WowCollectionFeature() {
  const image = subjectImages.medina;
      ...
      <div className="container-wide">
        <div className="card-signature grid gap-0 overflow-hidden border-white/10 bg-white/5 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center bg-[#faf8f5] p-8 text-gray-900 sm:p-10 lg:p-12">
            <p className="section-eyebrow text-coastal-700">Future Tangier exclusives</p>
            ...
            <p className="mt-4 text-base italic leading-relaxed text-gray-700">
              &ldquo;A future collection of distinctive small-group Moroccan days, developed around
              local expertise, thoughtful pacing and the realities of a Tangier cruise call.&rdquo;
            </p>
            <p className="mt-4 text-sm leading-relaxed text-gray-600">
              The collection is still in preparation. Proposed experiences include an Exclusive Medina
              &amp; Kasbah Discovery, a carefully paced Cape Spartel Afternoon and private Chefchaouen
            ...
            <div className="mt-6 grid gap-2 sm:grid-cols-2">
              {[
                { emoji: "🕌", text: "Future Exclusive Medina & Kasbah experience" },
                { emoji: "🌊", text: "Future Cape Spartel Afternoon concept" },
                { emoji: "🚗", text: "Future private Chefchaouen routes" },
