...
function MarkSvg({
  ...
  // Concept A (active): Anchor Arch — Strait gateway mark meeting a restrained anchor.
  return (
    <svg
      width={size}
      height={size}
 ...
 *
 * Logo refinement (Tangier): icon slightly subordinate to TANGIER,
...
export function DestinationLogo({
  ...
  const onDark = tone === "on-dark";
  // ~12% smaller than the first prototype so TANGIER stays dominant
