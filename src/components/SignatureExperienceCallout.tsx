...
const CONTEXT_COPY = {
  portofino: "Considering Cape Spartel? Our future Signature Strait of Gibraltar Discovery is being designed as a carefully paced small-group coastal day.",
  savona: "Exploring the Medina? Our future Wow Collection will add distinctive small-group Tangier routes developed around cruise timings.",
  general: "Our future flagship Signature Strait of Gibraltar Discovery is a proposed small-group Tangier experience. It is still in preparation.",
};
  ...
  if (compact) {
    return (
      <div className="card-signature mt-10">
        ...
        <h2 className="mt-4 font-display text-xl font-bold text-gray-900">{signatureTangierExperience.title}</h2>
