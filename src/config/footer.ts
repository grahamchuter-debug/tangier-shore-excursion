...
export const footerColumns: FooterColumns = {
  blurb:
    "Helping cruise passengers plan a confident day ashore in Tangier — honest advice on walking from port, the Medina, Kasbah, Cape Spartel and Morocco beyond the city walls.",
  ...
  choose: [
    ...
    { href: "/compare/first-time-tangier-day", label: "First-time Tangier" },
