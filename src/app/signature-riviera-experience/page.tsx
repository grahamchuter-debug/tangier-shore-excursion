...
import { signatureTangierExperience, SIGNATURE_EXPERIENCE_PATH } from "@/data/signature-experience";
...
export const metadata = buildMetadata({
  title: signatureTangierExperience.seoTitle,
  description: signatureTangierExperience.metaDescription,
  path,
  image: image.src,
  imageAlt: "Tangier coastline — future Signature Experience from Tangier cruise port",
  keywords: [
    "Signature Strait of Gibraltar Discovery",
    "Tangier shore excursions",
    "small group Tangier tour",
    "Morocco cruise excursions",
  ],
});

const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Signature Strait of Gibraltar Discovery", path },
];

export default function SignatureTangierExperiencePage() {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbSchema(breadcrumbs),
          faqSchema(signatureTangierExperience.faqs),
          articleSchema({
            title: signatureTangierExperience.seoTitle,
            description: signatureTangierExperience.metaDescription,
            path,
      ...
      <section className="section-signature-hero">
        ...
        <div className="container-wide relative z-10 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <h1 className="home-hero-heading mt-6 max-w-3xl">{signatureTangierExperience.title}</h1>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-white/90">
            {signatureTangierExperience.tagline}
          </p>
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/75">
            {signatureTangierExperience.overview}
          </p>
        ...
        <div className="container-wide max-w-4xl">
          ...
          <div className="placeholder-widget mt-8">
            ...
            <p className="mt-3 text-gray-700 leading-relaxed">
              ...
              guests, cruise-timed routing and a carefully paced Tangier day. It is a
              concept in preparation, not a currently bookable excursion.
            </p>
          </div>

          <div className="mt-10 grid gap-3 sm:grid-cols-2">
            {signatureTangierExperience.benefits.map((b) => (
          ...
          <div className="mt-12">
            <FAQSection faqs={signatureTangierExperience.faqs} title="Signature Strait of Gibraltar Discovery — FAQs" />
          </div>
