...
const description =
  "The complete Tangier cruise port guide — terminal layout, walking routes, taxis, Medina access and return-to-ship timing.";
...
export const metadata = buildMetadata({
  ...
  image: image.src,
  imageAlt: image.alt,
  keywords: ["Tangier cruise port", "Tangier cruise terminal", "Tangier port to Medina", "Tangier cruise port guide"],
});

const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Tangier Cruise Port Guide", path },
];
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          <div className="mt-12">
            <FAQSection faqs={portGuideFaqs} title="Tangier port FAQs" />
          </div>
