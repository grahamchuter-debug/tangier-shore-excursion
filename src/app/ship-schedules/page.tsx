...
export const metadata = buildMetadata({
  title: "Tangier Cruise Ship Schedules",
  description:
    "Tangier cruise ship schedules by year and month. See which ships call before booking Medina, Cape Spartel or city excursions.",
  path,
  keywords: ["Tangier cruise ship schedule", "Tangier cruise calendar", "Tangier ship schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Tangier Cruise Ship Schedules", description: "Tangier cruise ship schedules by year and month.", path })]} />
      <PageHero title="Tangier Cruise Ship Schedules" subtitle="See which ships are in port before you book Morocco excursions. Times and berths are indicative — always confirm with your cruise line." compact />
