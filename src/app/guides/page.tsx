...
const path = "/guides";
const description =
  "Morocco cruise planning guides from Tangier — Medina, Kasbah, Cape Spartel, Chefchaouen and practical port-day advice.";

export const metadata = buildMetadata({
  title: "Morocco Cruise Planning Guides from Tangier",
  description,
  path,
  keywords: [
    "Tangier cruise port guide",
    "Tangier Medina from cruise port",
    "Tangier shore excursions guide",
    "Cape Spartel from Tangier",
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({ title: "Morocco Cruise Planning Guides from Tangier", description, path }),
        ]}
      />
      <PageHero
        title="Morocco Cruise Planning Guides"
        subtitle="Your gateway to Tangier — Medina, Kasbah, Cape Spartel, Chefchaouen and practical advice for every type of cruise passenger."
