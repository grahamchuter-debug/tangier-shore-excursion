...
export const metadata = buildMetadata({
  title: "Tangier Shore Excursions | Where Europe Meets Africa",
  description:
    "Discover Morocco from Tangier — Medina, Kasbah, Cape Spartel, Hercules Caves and carefully selected shore excursions designed around your cruise schedule.",
  path: "/",
  keywords: [
    ...
    "Tangier Medina",
    "Walking From Tangier Cruise Port",
    "Morocco Shore Excursions",
  ],
});

const SITE_DESCRIPTION =
  "Independent Tangier shore excursions and honest cruise-port guidance — Medina, Kasbah, Cape Spartel, Hercules Caves and Morocco beyond the walkable core.";
    ...
    <>
      <JsonLd
        data={[
          ...
          faqSchema(faqs),
          travelGuideSchema({
            title: "Tangier — Where Europe Meets Africa",
      ...
      <ExperienceCards
        ...
        subtitle="Choose how you want to experience Tangier — walk the Medina independently, explore with cultural context, or join our Editor's Choice coastal day."
      />
      <ChooseYourDay />
      <SpiritOfPlace />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          <EditorsChoice
            tagline="Tangier Highlights, Cape Spartel & Hercules Caves — our favourite first-time balance of Medina colour and the Atlantic edge."
          />
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-wide">
          <div className="max-w-2xl">
            ...
            <h2 className="section-title mt-2">Everything you need for Tangier</h2>
          </div>
      ...
      <FAQSection faqs={faqs} title="Tangier shore excursion FAQs" />
    </>
  );
}
