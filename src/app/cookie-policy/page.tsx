...
export const metadata = buildMetadata({
  title: "Cookie Policy",
  description: `Cookie policy for ${SITE.name} — how we use cookies and similar technologies on ${SITE.url}.`,
  path,
  noindex: true,
});
        ...
        <div className="container-wide max-w-3xl">
          ...
          <div className="mt-6 space-y-4 text-gray-700 leading-relaxed">
            <p>
              ...
              remember preferences and understand how visitors use our Tangier and Morocco planning guides.
            </p>
            <p>
