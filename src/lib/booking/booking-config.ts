/**
 * Booking engine configuration — Tangier multi-product checkout experience.
 */
...
export const bookingPrototypeTour: BookingTourView = (() => {
  const first = getBookableProduct("tangier-highlights-cape-spartel-hercules-caves");
...
export const bookingPricingConfig = {
  ...
  priceConfigured: Boolean(getBookableProduct("tangier-highlights-cape-spartel-hercules-caves")),
  ...
  returnGuaranteeDetail:
    "Your itinerary is planned to return you to Tangier with time before your ship departs.",
